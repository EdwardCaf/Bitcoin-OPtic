...
const scenarios = [
  {
    ...
    result: "Recoverable",
    description:
      "The device is replaceable if your seed phrase and optional passphrase are available.",
    action:
      "Buy a new wallet, restore the seed, verify receive addresses, then move funds if theft is possible.",
  },
  {
    id: "lost-seed",
    ...
    result: "High risk",
    description:
      "If the device also fails, there is no remaining way to reconstruct the private keys.",
    action:
      "Copy down the seed phrase again onto paper or ideally metal before device possibly breaks. If seed was compromised, create new seed and move funds over.",
  },
  {
    ...
    result: "Funds lost",
    description:
      "A passphrase creates a different wallet. The seed alone cannot recover passphrase-protected funds.",
    action:
      "Only use a passphrase if you can back it up separately and test recovery before storing meaningful value.",
  },
  {
    id: "house-fire",
    ...
    <Card variant="elevated" padding="large" className={styles.container}>
      <div className={styles.header}>
        <div>
          ...
          <p>
            Choose a failure and see whether your backup plan still gives you
            access.
          </p>
        </div>
        <HelpCircle size={24} />
