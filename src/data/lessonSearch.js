...
export const lessonSections = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        keywords: ['backup', 'backups', 'recovery', 'seed backup', 'passphrase', 'inheritance', 'multisig backup', 'storage', 'bip85', 'bip-85', 'derived seeds'],
        sections: buildSections([
          ...
          { id: 'derived-seeds', title: 'Derived Seeds', keywords: ['bip85', 'bip-85', 'derived seeds', 'child seeds', 'deterministic entropy', 'hot wallet seeds'] },
