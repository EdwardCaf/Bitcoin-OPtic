    ...
    resources: [
      {
        ...
        description:
          "Full-featured desktop wallet with advanced coin control and privacy features.",
        tags: ["Desktop"],
        icon: Monitor,
        favorite: true,
      },
      {
        ...
        description:
          "Collaborative multisig wallet for desktop with assisted key management.",
        tags: ["Desktop", "Mobile"],
        icon: Shield,
      },
    ],
    ...
    resources: [
      {
        ...
        description:
          "Self-custody mobile wallet with hardware wallet support and Liquid integration.",
        tags: ["Mobile", "Liquid"],
        favorite: true,
        icon: Smartphone,
      },
      ...
      },
      {
        ...
        url: "https://nunchuk.io",
        description:
          "Collaborative multisig wallet for mobile with assisted key management and support for NFC.",
        tags: ["Desktop", "Mobile"],
        icon: Shield,
      },
      {
        ...
        description:
          "Mobile wallet with multisig support, hardware wallet integration, and advanced privacy features.",
        tags: ["Mobile"],
        icon: Shield,
      },
    ],
    ...
    resources: [
      {
        ...
        description:
          "Self-custodial Lightning wallet with automatic channel management.",
      ...
      },
      {
        ...
        description:
          "Mobile wallet for managing your Lightning node and on-chain funds.",
        tags: ["Lightning", "Mobile"],
        icon: Zap,
      },
    ],
    ...
    resources: [
      {
        ...
        description:
          "Cashu ecash wallet with focus on privacy and ease of use.",
        tags: ["Ecash", "Mobile"],
        icon: Coins,
      },
      {
      ...
      },
      {
        ...
        url: "https://Cashu.me",
        description:
          "Progressive Web App Cashu wallet with built-in mint discovery.",
        tags: ["Ecash", "Mobile"],
        icon: Coins,
      },
      {
        ...
        url: "https://fedi.xyz",
        description:
          "Fedimint-based community custody wallet with ecash and Lightning support.",
  ...
  liquidWallets: {
    ...
    resources: [
      ...
      },
      {
        ...
        description:
          "Multi-platform wallet supporting Bitcoin and Liquid Network.",
  ...
  hardware: {
    ...
    resources: [
      ...
      },
      {
        ...
        description:
          "Budget-friendly hardware wallet with QR air-gapped signing.",
      ...
      },
      {
        ...
        description:
          "Open-source, air-gapped hardware wallet with a beautiful interface.",
        tags: ["Air-gapped"],
        icon: Shield,
      },
      {
        ...
        description:
          "Bitcoin-only edition hardware wallet with secure element and touchscreen.",
        tags: ["Bitcoin-only"],
        icon: Shield,
      },
    ],
    ...
    resources: [
      {
        ...
        description:
          "Sovereign computing platform for running Bitcoin and other services.",
        tags: ["Node"],
        icon: Server,
        favorite: true,
      },
      {
        ...
        description:
          "User-friendly home server for Bitcoin, Lightning, and apps.",
        tags: ["Node"],
        icon: Server,
      },
      {
    ...
    resources: [
      {
        ...
        description:
          "Canadian non-custodial Bitcoin exchange with focus on self-custody.",
      ...
      },
      {
        ...
        description:
          "Private peer-to-peer Bitcoin exchange over Lightning and Tor.",
        tags: ["P2P"],
        icon: Zap,
      },
      {
    ...
    resources: [
      {
        ...
        description:
          "Video tutorials covering wallets, nodes, Lightning, and privacy.",
      ...
      },
      {
        ...
        description:
          "Official Bitcoin resource with guides, documentation, and wallet info.",
        tags: ["Reference"],
        icon: BookOpen,
      },
      {
        ...
        description:
          "Literature and research on Bitcoin, cryptography, and Austrian economics.",
    ...
    resources: [
      {
        ...
        description:
          "Andreas Antonopoulos's comprehensive technical guide to Bitcoin (free online).",
        tags: ["Technical"],
        icon: BookOpen,
      },
      {
        ...
        description:
          "Satoshi Nakamoto's original Bitcoin whitepaper from 2008.",
        tags: ["Documentation"],
        icon: BookOpen,
      },
    ],
...
function ResourceCard({ resource, index }) {
  ...
  const cardClasses = [styles.card, resource.favorite && styles.cardFavorite]
    .filter(Boolean)
    .join(" ");
        ...
        <div className={styles.mobileLeft}>
          ...
          <div className={styles.mobileTitleGroup}>
            <h3 className={styles.cardTitle}>
              {resource.name}
              {resource.favorite && (
                <span className={styles.favoriteBadgeMobile}>Recommended</span>
              )}
            </h3>
          </div>
        </div>
    ...
    <div className={styles.container}>
      ...
      >
        ...
        <p className={styles.heroText}>
          A curated collection of Bitcoin-only wallets, hardware, node software,
          exchanges, educational content, and tools.
        </p>
      </motion.section>
      ...
      >
        <p>
          <strong>Disclaimer:</strong> These resources are provided for
          educational purposes. Always do your own research (DYOR) before using
